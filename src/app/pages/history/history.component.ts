  ...
  history: History[] = [
    {
      "date":"2000/1/1",
      "title":"サンプル",
      "desc":"吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。\n何でも薄暗いじめじめした所でニャーニャー泣いていた事だけは記憶している。\n吾輩はここで始めて人間というものを見た。\nしかもあとで聞くとそれは書生という人間中で一番獰悪な種族であったそうだ。\nこの書生というのは時々我々を捕えて煮て食うという話である。",
      "type":"YouTube埋め込み",
      "url":"https://www.youtube.com/watch?v=JxcKj2dMZM8"
    }, {
      "date":"2019/10/18",
      "title":"花と椿と君",
      "desc":"花と椿と君にてKAMITSUBAKI STUDIO発足が発表。\n「理芽」、「春猿火」、「ヰ世界情緒」の三人のデビュー",
      "type":"YouTube埋め込み",
      ...
      "date":"2020/5/30",
      "title":"花達と椿と君。vol2",
      "desc":"神椿市建設中を発表.アイスクリームライブの開催決定。\nリアルとバーチャルの境界線のアーティストte'resaデビュー",
      "type":"YouTube埋め込み",
